...
fn default_response(command: &str) -> CannedResponse {
    let body = if command.contains("# jiji-request:catalog-list") {
        ...
        r#"{"Ok":{"type":"desired_state","record":{"project_id":"demo","recovery_epoch":1,"protocol_version":1,"schema_version":2,"service":"gluetun","scale_override":1,"revision":1,"author_node_id":"app","author_epoch":1}}}"#
        ...
        r#"{"Ok":{"type":"image_retention_applied","spec":{"service":"gluetun","repo":"localhost:31270/demo-gluetun","retain":3,"revision":1}}}"#
