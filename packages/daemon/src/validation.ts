/**
 * Shared input validation for the daemon.
 *
 * All data from Corrosion (CRDT database) is untrusted and must be
 * validated before use in SQL queries, shell commands, or network calls.
 */
